...
const crearCobro = async () =>{
    ...
    try{
        if(!regexCodigo.test(codigoCobro) && !codigoCobro && !Regextipo.test(tipoCobro) && !tipoCobro && !descripcion && !valor){
            throw new Error('Los campos no son validos o estna vacios');
        }
        let cobro = {
